...
= 2.0.5 =
* Added plugin icon and banner images (icon-128x128, icon-256x256, banner-772x250, banner-1544x500)
* Updater now accepts both PNG and JPG for all icon and banner files; first matching format wins
